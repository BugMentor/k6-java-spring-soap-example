...
@DataJpaTest
@ActiveProfiles("test")
@DisplayName("Payment Repository Integration Tests (H2)")
class PaymentRepositoryH2IntegrationTest {
    ...
    private User createTestUser() {
        User user = new User(UUID.randomUUID(), "payment@test.com", "Payment User", "ACTIVE");
